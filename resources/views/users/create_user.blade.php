...
@section('content')
    ...
    <div class="alert alert-primary" role="alert"><?= get_label('acc_crea_email_enabled_inf', 'As Account Creation Email Status is Active, Please Ensure Email Settings Are Configured and Operational.') ?> </div>
    @endif
        <div class="card">
            <div class="card-body">
