...
class TasksController extends Controller
{
    ...
    public function calendar_view()
    {
        ...
        return view('tasks.calendar_view', compact('projects'));
    }
    public function get_calendar_data(Request $request)
    {
        ...
        $tasksQuery->whereBetween('start_date', [$start, $end])
        ...
        $events = $tasks->map(function ($task) {
            return [
                ...
                'end' => Carbon::parse($task->due_date)->addDay()->format('Y-m-d'), // Add a day to end date
